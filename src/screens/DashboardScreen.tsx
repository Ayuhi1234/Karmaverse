...
const FEATURES = [
  ...
  },
  {
    ...
    tag: 'EARN',
    title: 'KarmaCoins XP',
    desc: 'Every kilogram of materials you recover earns you KarmaCoins XP. Keep your streaks up for even more rewards!',
    benefit: 'Reward for Every kg',
    benefitIcon: <Star size={16} color="#fbbf24" fill="#fbbf24" />,
    bg: ['#312e81', '#4338ca'] as [string, string],
    accent: '#a78bfa',
    steps: ['Recover materials', 'Maintain streak 🔥', 'Get rewarded'],
    navTarget: 'Wallet',
